package com.br.library.library.openApi;
    ...
    public OpenAPI customOpenApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("Api Library")
                        .version("1.0.0")
                        .description("Api for controller books to people")
                        .termsOfService("https://github.com/AllisonMarquesSouza/LibraryManeger")
                        .contact(new Contact()
